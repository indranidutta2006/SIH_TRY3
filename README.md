...
The [`MaritimeLifecycleAssessmentEngine`](file:///src/lifecycle/lifecycle_assessment_engine.py) models the Well-to-Wake lifecycle climate impact of marine fuels across Well-to-Tank (upstream feedstock extraction, synthesis, liquefaction, transport) and Tank-to-Wake (onboard combustion and fuel cell operations):
